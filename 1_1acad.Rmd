...
table1 <- freq_n_ord(quest_22$instituicao)
table2 <- freq_ord(quest_22$instituicao)
```
...
table2 <- freq_n_ord(quest_22$instituicao)
...
table1 <- freq_ord(quest_22$setor_ufpr)

table2 <- freq_ord(subset(quest_22, quest_22$instituicao == 'ufpr')$setor_ufpr)
...
table2 <- freq_n_ord(subset(quest_22, quest_22$instituicao == 'ufpr')$setor_ufpr)
...
compara <- rbind(freq_n_ord(quest_22$setor_ufpr),
                 freq_n_ord(quest_21$setor_ufpr),
...
compara$Ano <- c(rep('2022',14), rep('2021',14), 
                 rep('2020',14), rep('2019',14))
...
table1 <- freq_n_ord(quest_22$atividade_ies)
...
table1 <- freq_ord(quest_22$atividade_ies)
...
table1 <- freq_ord(quest_22$area_conhec)
```
...
table1 <- freq_n_ord(quest_22$area_conhec)
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
fim_grad <- subset(quest_22, fim_grad<2021 & fim_grad>1950)
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
table1 <- freq_ord(quest_22$inst_grad)
...
# tratamento
quest_22$programas_grad <- tolower(iconv(quest_22$programas_grad, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$programas_grad <- gsub(",",";",quest_22$programas_grad)

# gerando vetor

vet <- as.vector(cSplit(quest_22, 
                        "programas_grad", 
                        sep = ";", 
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
table1 <- freq_ord(quest_22$inst_msc)
...
table1 <- freq_ord(subset(quest_22, final_msc <= 2022)$inst_msc)
...
compara$Ano <- c(rep('2022',9), rep('2021',11), 
                 rep('2020',11), rep('2019',11))
...
artigos <- subset(quest_22, artigos >= 0)
...
table1 <- freq_ord(quest_22$bolsa)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
table1 <- freq_n_ord(quest_22$bolsa)
...
materias_est <- subset(quest_22, materias_est >= 0)
...
materias_est_pos <- subset(quest_22, materias_est_pos >= 0)
...
table1 <- freq_ord(quest_22$software_sn)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_22$software_sn),
...
# tratamento
quest_22$software_list <- tolower(iconv(quest_22$software_list, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$software_list <- gsub(",",";",quest_22$software_list)
...
table1 <- freq_ord(quest_22$met_est)
```
...
table1 <- freq_n_ord(quest_22$met_est)
...
import_met_est <- subset(quest_22, import_met_est >= 0)
...
table1 <- freq_ord(quest_22$expectativa_pos_pg)
```
...
table1 <- freq_n_ord(quest_22$expectativa_pos_pg)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_22$expectativa_pos_pg),
...
compara$Ano <- c(rep('2022',4),rep('2021',4), 
...
table1 <- freq_ord(quest_22$conhec_trans)
```
...
table1 <- freq_n_ord(quest_22$conhec_trans)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_22$conhec_trans),
...
table1 <- freq_ord(quest_22$youtube)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_22$youtube),
...
table1 <- freq_ord(quest_22$contat_coord)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_22$contat_coord),
...
table1 <- freq_ord(quest_22$contat_colab)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_22$contat_colab),
...
table1 <- freq_ord(quest_22$ensino_medio1)
```
...
table1 <- freq_n_ord(quest_22$ensino_medio1)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_22$ensino_medio1),
...
table1 <- freq_ord(quest_22$ensino_medio2)
```
...
table1 <- freq_n_ord(quest_22$ensino_medio2)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_22$ensino_medio2),

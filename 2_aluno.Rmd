...
table1 <- freq_n_ord(quest_22$sexo)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_22$sexo),
...
altura <- subset(quest_22, altura >= 100 & altura <= 250)
...
peso <- subset(quest_22, peso >= 15 & peso <= 500)
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
quest_22$nascimento <- as.Date(quest_22$nascimento, "%d/%m/%Y")

quest_22$idade <- floor(difftime(Sys.Date(), quest_22$nascimento, units = "weeks")/52)

quest_22$idade <- as.integer(quest_22$idade)

idade <- subset(quest_22, idade >= 15 & idade <= 100)
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
mes <- month(as.POSIXlt(quest_22$nascimento, format="%d-%m-%Y"))
...
table1 <- freq_ord(quest_22$emprego)
...
table1 <- freq_n_ord(quest_22$emprego)
...
compara <- rbind(freq_n_ord(quest_22$emprego),
...
compara$Ano <- c(rep('2022',5), rep('2021',5), 
...
## Tabelas de frequencia
table1 <- freq_ord(quest_22$residencia)
...
table1 <- freq_n_ord(quest_22$residencia)
...
compara <- rbind(freq_n_ord(quest_22$residencia),
...
irmaos <- subset(quest_22, irmaos >= 0)
...
## Tabelas de frequencia
table1 <- freq_ord(quest_22$origem)
...
table1 <- freq_n_ord(quest_22$origem)
...
compara <- rbind(freq_n_ord(quest_22$origem),
...
## Tabelas de frequencia
table1 <- freq_ord(quest_22$transporte)
...
table1 <- freq_n_ord(quest_22$transporte)
...
compara <- rbind(freq_n_ord(quest_22$transporte),
...
compara$Ano <- c(rep('2022',8), rep('2021',8), 
...
tempo_ies <- subset(quest_22, tempo_ies >= 0 & tempo_ies<=700)
...
app_transporte <- subset(quest_22, app_transporte >= 0 & app_transporte<=700)
...
# tratamento
quest_22$pet <- tolower(iconv(quest_22$pet, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$pet <- gsub(",",";",quest_22$pet)
...
# tratamento
quest_22$instrumento <- tolower(iconv(quest_22$instrumento, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$instrumento <- gsub(",",";",quest_22$instrumento)
...
# tratamento
quest_22$redes_sociais <- tolower(iconv(quest_22$redes_sociais, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$redes_sociais <- gsub(",",";",quest_22$redes_sociais)
...
```{r, echo=FALSE}
## 2021
quest_22$atv_fisica_reg <- tolower(iconv(quest_22$atv_fisica_reg,
                                      to ='ASCII//TRANSLIT', 
                                      from = "UTF-8"))

quest_22$atv_fisica_reg <- factor(quest_22$atv_fisica_reg, 
                               levels = tolower(c("sim", "nao")))


# tabela

table1 <- freq_ord(quest_22$atv_fisica_reg)
```
...
atv_fisica_n <- subset(quest_22, atv_fisica_n >= 0 & atv_fisica_n<=7)
...
# tratamento
quest_22$atv_fisica_qual <- tolower(iconv(quest_22$atv_fisica_qual, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_22$atv_fisica_qual <- gsub(",",";",quest_22$atv_fisica_qual)
